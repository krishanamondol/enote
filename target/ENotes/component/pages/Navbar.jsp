    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="AddNote.jsp"><i class="fa fa-plus"></i> Add Notes</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link " href="ShowNote.jsp"><i class="fa fa-sticky-note"></i> Show Notes</a>
                </li>
            </ul>
            ...
            <% }else {%>
            <a href="Register.jsp" class="btn btn-outline-success my-2 my-sm-0 mr-3" type="submit">Register</a>
